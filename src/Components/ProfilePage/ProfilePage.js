            ...
            <React.Fragment>
                ...
                <div className='profilePageContainer'>
                    <div className='w-100 d-flex justify-content-around pt-3'>
                        <span className='profileNavigate IranSans font-weight-bold text-nowrap '>کوکی کلاب</span>
                        <span className='profileNavigate profileNavigateActive IranSans font-weight-bold text-nowrap'> سفارش های من</span>
                        <span className='profileNavigate IranSans font-weight-bold text-nowrap invisible'>کوکی کلاب</span>
                    </div>
                    <div className='w-100 profileHistoryContainer'>
