    ...
    increaseSelectedFood = (foodId, newNumber, maxNumber) =>{
        ...
        this.setState({
            selectedToPay: produce(this.state.selectedToPay, (draft=> {
                ...
                if(!isUpdatedFlag){
                    let newSelectedFood = produce(this.state.orderList.filter(eOFood => eOFood.id === foodId)[0],draft=>{draft.number = 1})
            ...
            return(
                ...
                <div key={eFood.id} id={eFood.id} className='eachDongContainer position-relative w-100' >
                    ...
                    <div className='d-flex flex-row-reverse align-items-center dongNumberHolder text-center justify-content-center  m-auto'>
                        ...
                        <AddRoundedIcon onClick={()=>{this.increaseSelectedFood(eFood.id, selectedNumber+1, totalNumber)}} className='w-25'/>
                        <div className='dongNumberOfFood '>X {selectedNumber}</div>
                        <RemoveRoundedIcon onClick={()=>{this.decreaseSelectedFood(eFood.id,selectedNumber+1)}} className='w-25'/>
        ...
        return (
            <React.Fragment>
                ...
                <div className='dongiPageContainer d-flex flex-column'>
                    ...
                    <div onClick={this.handleSubmit} className='DongiSubmitButton mt-5'>
                        <span>پرداخت</span>
                    </div>
                </div>
            </React.Fragment>
